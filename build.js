...
<body class="bg-gradient-to-b from-slate-800 to-slate-950 text-gray-300 font-sans leading-relaxed blog-body">
    ...
    <!-- Main Content Area -->
    <main class="container mx-auto px-6 py-12 blog-main">
